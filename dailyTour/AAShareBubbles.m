...
//    self.listPlanController = [[ListPlanController alloc] initWithNibName:@"ListPlanController" bundle:nil];
//    [self presentViewController:self.listPlanController animated:YES
//                     completion:^{
//                     }];
//    self.listPlanController=[[UIStoryboard storyboardWithName:@"Main" bundle:nil]instantiateViewControllerWithIdentifier:@"ListPlanController"];
//        [self addSubview:self.listPlanController.view];
//    self.window = [[UIWindow alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
//    self.listPlanController=[[UIStoryboard storyboardWithName:@"Main" bundle:nil]instantiateViewControllerWithIdentifier:@"ListPlanController"];
//    
//    self.window.rootViewController = self.listPlanController;
//    [self.window makeKeyAndVisible];
    [self.delegate goToPage];
    
    
    
//    [self.listPlanController addSubview: self.listPlanController.view ];
